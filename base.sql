USE [master]
GO
/****** Object:  Database [ComputerFirm]    Script Date: 12/08/2013 16:56:14 ******/
...
( NAME = N'ComputerFirm', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL10_50.MSSQLSERVER\MSSQL\DATA\ComputerFirm.mdf' , SIZE = 2304KB , MAXSIZE = UNLIMITED, FILEGROWTH = 1024KB )
 LOG ON 
( NAME = N'ComputerFirm_log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL10_50.MSSQLSERVER\MSSQL\DATA\ComputerFirm_log.LDF' , SIZE = 832KB , MAXSIZE = 2048GB , FILEGROWTH = 10%)
GO
...
USE [ComputerFirm]
GO
/****** Object:  Table [dbo].[Товар]    Script Date: 12/08/2013 16:56:15 ******/
SET ANSI_NULLS ON
GO
...
INSERT [dbo].[Товар] ([ID_товара], [Название_товара], [Категория], [Количество_склад], [Цена], [Количество_магазин], [Срок_гарантии], [Код_сервисного_центра]) VALUES (N'COCAMF4730', N'МФУ A4 Canon i-SENSYS MF4730 (МФУ)', N'Монохромные_лазерные_МФУ', 6, 2276000.0000, 7, 12, 5)
...
/****** Object:  StoredProcedure [dbo].[Удалить_товар]    Script Date: 12/08/2013 16:56:16 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  View [dbo].[Товары_без_гарантии]    Script Date: 12/08/2013 16:56:17 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Trigger [tD_Товар]    Script Date: 12/08/2013 16:56:17 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  View [dbo].[Max_Цены_по_категориям]    Script Date: 12/08/2013 16:56:17 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GROUP BY Категория
GO
/****** Object:  StoredProcedure [dbo].[CURSOR_Сформировать_Балансовый_отчёт]    Script Date: 12/08/2013 16:56:17 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  View [dbo].[Средняя_Цена_по_категории]    Script Date: 12/08/2013 16:56:17 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GROUP BY Категория
GO
/****** Object:  Table [dbo].[Заказ_Товар_Поставщик]    Script Date: 12/08/2013 16:56:17 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
INSERT [dbo].[Заказ_Товар_Поставщик] ([Код_поставщика], [Количество_заказано], [ID_товара], [ID_Заказа], [Дата_заказа], [Номер_паспорта_клиента]) VALUES (3, 1, N'CRHPC6578DE', 4, CAST(0x0000A28D013AA88E AS DateTime), N'qw2332422')
INSERT [dbo].[Заказ_Товар_Поставщик] ([Код_поставщика], [Количество_заказано], [ID_товара], [ID_Заказа], [Дата_заказа], [Номер_паспорта_клиента]) VALUES (3, 1, N'COCAMF4570DN', 5, CAST(0x0000A28D013AF2D1 AS DateTime), N'qe1412414')
SET IDENTITY_INSERT [dbo].[Заказ_Товар_Поставщик] OFF
/****** Object:  Table [dbo].[Клиент]    Script Date: 12/08/2013 16:56:17 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
INSERT [dbo].[Клиент] ([ФИО_клиента], [Дата_рождения], [Адрес_клиента], [Телефон_домашний], [Телефон_мобильный], [Номер_паспорта_клиента]) VALUES (N'ЧЕЛОВЕК', CAST(0x0000722300000000 AS DateTime), N'Адрес', N'123456', N'1234567890', N'kb1234567890')
...
INSERT [dbo].[Клиент] ([ФИО_клиента], [Дата_рождения], [Адрес_клиента], [Телефон_домашний], [Телефон_мобильный], [Номер_паспорта_клиента]) VALUES (N'ЖУКОВ Р.С.', CAST(0x000084DE00000000 AS DateTime), N'Могилёв', N'453919', N'375296580681', N'qw1234567')
...
/****** Object:  Table [dbo].[Кредитный_договор]    Script Date: 12/08/2013 16:56:17 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
INSERT [dbo].[Кредитный_договор] ([Код_договора], [Ежемесячная_выплата], [Первоначальный_взнос], [Срок_оплаты], [Номер_паспорта_клиента]) VALUES (5, 10000.0000, 120000.0000, 10, N'qe1412414')
SET IDENTITY_INSERT [dbo].[Кредитный_договор] OFF
/****** Object:  Table [dbo].[Продажа]    Script Date: 12/08/2013 16:56:17 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
INSERT [dbo].[Продажа] ([Цена], [Количество], [ID_товара], [Код_договора], [Тип_оплаты], [Код_гарантийного_талона]) VALUES (716500.0000, 1, N'CRHPC6578AE', 4, N'Наличный', 12)
INSERT [dbo].[Продажа] ([Цена], [Количество], [ID_товара], [Код_договора], [Тип_оплаты], [Код_гарантийного_талона]) VALUES (420000.0000, 1, N'CRHPC6578DE', NULL, N'Наличный', 12)
/****** Object:  Table [dbo].[Гарантийный_талон]    Script Date: 12/08/2013 16:56:17 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
INSERT [dbo].[Гарантийный_талон] ([Дата_время], [Номер_паспорта_сотрудника], [Код_гарантийного_талона], [Серийный_номер_экземпляра]) VALUES (CAST(0x0000A28D00F5D6B7 AS DateTime), N'КВ1684611', 17, N'1312e2')
SET IDENTITY_INSERT [dbo].[Гарантийный_талон] OFF
/****** Object:  Table [dbo].[Сотрудник]    Script Date: 12/08/2013 16:56:17 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
/****** Object:  Trigger [Форматирование_данных_Сотрудник]    Script Date: 12/08/2013 16:56:17 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  Table [dbo].[Сервисный_центр]    Script Date: 12/08/2013 16:56:17 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
/****** Object:  Trigger [update_сервис_для_товара]    Script Date: 12/08/2013 16:56:17 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  Trigger [tU_Сервисный_центр]    Script Date: 12/08/2013 16:56:17 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  Trigger [tD_Сервисный_центр]    Script Date: 12/08/2013 16:56:17 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  Trigger [проверка_возраста]    Script Date: 12/08/2013 16:56:17 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[Приёмка_Товара]    Script Date: 12/08/2013 16:56:17 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
DECLARE @Код_сервисного_центра int
	...
	End
GO
/****** Object:  View [dbo].[Прайс_фирмы]    Script Date: 12/08/2013 16:56:17 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
ORDER BY Категория
GO
/****** Object:  StoredProcedure [dbo].[Поиск_товар]    Script Date: 12/08/2013 16:56:17 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  Trigger [Отслеживание_колва_товара]    Script Date: 12/08/2013 16:56:17 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[Отправить_в_магазин]    Script Date: 12/08/2013 16:56:17 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  Trigger [tU_Кредитный_договор]    Script Date: 12/08/2013 16:56:17 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  Trigger [tD_Кредитный_договор]    Script Date: 12/08/2013 16:56:17 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  View [dbo].[Количество_видов_отсутствующих_на_складе_товаров]    Script Date: 12/08/2013 16:56:17 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Trigger [Форматирование_данных_Клиент]    Script Date: 12/08/2013 16:56:17 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  View [dbo].[Клиенты_по_возрасту]    Script Date: 12/08/2013 16:56:17 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
ORDER BY Возраст
GO
/****** Object:  Trigger [tD_Клиент]    Script Date: 12/08/2013 16:56:17 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  View [dbo].[Информация_о_Сотруднике]    Script Date: 12/08/2013 16:56:17 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
Select ФИО_сотрудника, Upper(Номер_паспорта_сотрудника)AS 'Номер_паспорта_сотрудника' ,
	...
	from Сотрудник
GO
/****** Object:  View [dbo].[Информация_о_Клиенте]    Script Date: 12/08/2013 16:56:17 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
Select ФИО_клиента, Upper(Номер_паспорта_клиента)AS 'Номер_паспорта_клиента' , Адрес_клиента, Телефон_мобильный
	from Клиент
GO
/****** Object:  StoredProcedure [dbo].[Зарегистрировать_Клиента]    Script Date: 12/08/2013 16:56:17 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
AS 
	...
	VALUES 
		...
		@Телефон_мобильный)
GO
/****** Object:  StoredProcedure [dbo].[Заключить_кредитный_договор]    Script Date: 12/08/2013 16:56:17 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  Table [dbo].[Поставщик]    Script Date: 12/08/2013 16:56:17 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
/****** Object:  Trigger [Удаление_поставщика_с_проверкой_заказов]    Script Date: 12/08/2013 16:56:17 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[Оформить_заказ_товара]    Script Date: 12/08/2013 16:56:17 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  Trigger [tU_Товар]    Script Date: 12/08/2013 16:56:17 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  Trigger [tU_Поставщик]    Script Date: 12/08/2013 16:56:17 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  Trigger [tU_Клиент]    Script Date: 12/08/2013 16:56:17 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[CURSOR_Показать_Ближайшие_Заказы]    Script Date: 12/08/2013 16:56:17 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  View [dbo].[Заемщики]    Script Date: 12/08/2013 16:56:17 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[Есть_ли_товар]    Script Date: 12/08/2013 16:56:17 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  View [dbo].[Детали_наименьшего_количества]    Script Date: 12/08/2013 16:56:17 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  View [dbo].[Сотрудник_Прибыль]    Script Date: 12/08/2013 16:56:17 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  View [dbo].[Продажи_за_текущий_месяц]    Script Date: 12/08/2013 16:56:17 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  View [dbo].[Продажи_за_текущий_год]    Script Date: 12/08/2013 16:56:17 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[Продажи_за_Месяц_Года]    Script Date: 12/08/2013 16:56:17 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
	...
	(Select [Код_гарантийного_талона]
			From dbo.[Гарантийный_талон]
				Where (Year([Дата_время])=@НомерГода
					and MONTH ([Дата_время])= @НомерМесяца)) as tmp_1
	 	 on	(tmp_1.Код_гарантийного_талона=Продажа.Код_гарантийного_талона)

END
GO
/****** Object:  StoredProcedure [dbo].[Продажи_за_Год]    Script Date: 12/08/2013 16:56:17 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
BEGIN	
 ...
 inner join
	(Select [Код_гарантийного_талона]
			From dbo.[Гарантийный_талон]
				Where (Year([Дата_время])=@НомерГода)) as tmp_1
	 	 on	(tmp_1.Код_гарантийного_талона=Продажа.Код_гарантийного_талона)

END
GO
/****** Object:  StoredProcedure [dbo].[Получить_номер_гарантийного_талона]    Script Date: 12/08/2013 16:56:17 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[Зарегистрировать_покупку]    Script Date: 12/08/2013 16:56:17 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
BEGIN
	...
	begin
	Insert Into dbo.[Продажа](Код_договора,Код_гарантийного_талона,ID_товара,Тип_оплаты,Количество,Цена)
		Values (null,@код_гарантийного_талона,@ID_,@Тип_оплаты,@Количество,@Сумм_цена)
	end	
	
END
GO
/****** Object:  Trigger [tU_Сотрудник]    Script Date: 12/08/2013 16:56:17 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  Trigger [tD_Сотрудник]    Script Date: 12/08/2013 16:56:17 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  Table [dbo].[Гарантийный_журнал]    Script Date: 12/08/2013 16:56:17 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [dbo].[Гарантийный_журнал](
	...
	[Дата_время] [datetime] NOT NULL,
	[Код_гарантийного_талона] [int] NOT NULL,
	[ID_записи] [int] IDENTITY(18,1) NOT NULL,
 CONSTRAINT [PK_Гарантийный_журнал] PRIMARY KEY CLUSTERED 
(
	[ID_записи] ASC
...
GO
SET IDENTITY_INSERT [dbo].[Гарантийный_журнал] ON
INSERT [dbo].[Гарантийный_журнал] ([Статус_обслуживания], [Примечание], [Причина_направления_на_замену], [Дата_время], [Код_гарантийного_талона], [ID_записи]) VALUES (N'Ремонт_1', N'---', N'---', CAST(0x0000A28E000DD544 AS DateTime), 23, 1)
INSERT [dbo].[Гарантийный_журнал] ([Статус_обслуживания], [Примечание], [Причина_направления_на_замену], [Дата_время], [Код_гарантийного_талона], [ID_записи]) VALUES (N'123', N'', N'123', CAST(0x0000A28E00113D22 AS DateTime), 123, 2)
INSERT [dbo].[Гарантийный_журнал] ([Статус_обслуживания], [Примечание], [Причина_направления_на_замену], [Дата_время], [Код_гарантийного_талона], [ID_записи]) VALUES (N'Ремонт завершён', N'', N'', CAST(0x0000A28E010DE3E5 AS DateTime), 12, 20)
INSERT [dbo].[Гарантийный_журнал] ([Статус_обслуживания], [Примечание], [Причина_направления_на_замену], [Дата_время], [Код_гарантийного_талона], [ID_записи]) VALUES (N'Ремонт завершён', N'', N'Гарантийная замена', CAST(0x0000A28E010DE3E2 AS DateTime), 12, 21)
SET IDENTITY_INSERT [dbo].[Гарантийный_журнал] OFF
/****** Object:  View [dbo].[Товары_с_частой_поломкой]    Script Date: 12/08/2013 16:56:17 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  View [dbo].[Список_вещей_на_гарантийной_замене]    Script Date: 12/08/2013 16:56:17 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[Количество_гарантийного_ремонта_по_категории]    Script Date: 12/08/2013 16:56:17 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[Зафиксировать_результаты_ремонта]    Script Date: 12/08/2013 16:56:17 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[Занести_запись_в_гарантийный_журнал]    Script Date: 12/08/2013 16:56:17 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[Зафиксировать_замену_по_гарантии]    Script Date: 12/08/2013 16:56:17 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  Trigger [tU_Гарантийный_талон]    Script Date: 12/08/2013 16:56:17 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  Trigger [tD_Гарантийный_талон]    Script Date: 12/08/2013 16:56:17 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[Выписать_гарантийный_талон]    Script Date: 12/08/2013 16:56:17 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  Trigger [Вставка_даты_заказа_товара]    Script Date: 12/08/2013 16:56:17 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  Trigger [Вставка_даты_заказа_гарантийного_ремонта]    Script Date: 12/08/2013 16:56:17 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[Аннулировать_заявку_на_ремонт]    Script Date: 12/08/2013 16:56:17 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
Set @date = (select Max(Дата_время)
					 from Гарантийный_журнал 
							where (Гарантийный_журнал.Код_гарантийного_талона = @Код_гарантийного_талона))
...
END
GO
/****** Object:  Table [dbo].[UserAccess]    Script Date: 12/08/2013 16:56:17 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
/****** Object:  Trigger [Hash_pass]    Script Date: 12/08/2013 16:56:18 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[GetUserGROUP]    Script Date: 12/08/2013 16:56:17 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  Default [CURRENT_TIMESTAMP_2042541508]    Script Date: 12/08/2013 16:56:17 ******/
ALTER TABLE [dbo].[Заказ_Товар_Поставщик] ADD  CONSTRAINT [CURRENT_TIMESTAMP_2042541508]  DEFAULT (getdate()) FOR [ID_товара]
GO
/****** Object:  Default [CURRENT_TIMESTAMP_]    Script Date: 12/08/2013 16:56:17 ******/
ALTER TABLE [dbo].[Продажа] ADD  CONSTRAINT [CURRENT_TIMESTAMP_]  DEFAULT (getdate()) FOR [ID_товара]
GO
/****** Object:  ForeignKey [Relationship_484]    Script Date: 12/08/2013 16:56:15 ******/
...
GO
/****** Object:  ForeignKey [заключает]    Script Date: 12/08/2013 16:56:17 ******/
...
GO
/****** Object:  ForeignKey [R_23]    Script Date: 12/08/2013 16:56:17 ******/
...
GO
/****** Object:  ForeignKey [R_24]    Script Date: 12/08/2013 16:56:17 ******/
...
GO
/****** Object:  ForeignKey [Relationship_456]    Script Date: 12/08/2013 16:56:17 ******/
...
GO
/****** Object:  ForeignKey [выдается_при]    Script Date: 12/08/2013 16:56:17 ******/
...
GO
/****** Object:  ForeignKey [заключается_при]    Script Date: 12/08/2013 16:56:17 ******/
...
GO
/****** Object:  ForeignKey [участвует_в]    Script Date: 12/08/2013 16:56:17 ******/
...
GO
/****** Object:  ForeignKey [выдает]    Script Date: 12/08/2013 16:56:17 ******/
...
GO
/****** Object:  ForeignKey [R_16]    Script Date: 12/08/2013 16:56:17 ******/
